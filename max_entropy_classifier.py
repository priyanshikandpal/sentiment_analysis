...
class MaxEntClassifier:
    ...
    def __init__(self, data, keyword, time, trainingDataFile, classifierDumpFile, trainingRequired = 0):
        ...
        #call training model
        if(trainingRequired):
            self.classifier = self.getMaxEntTrainedClassifier(trainingDataFile, classifierDumpFile)
        else:
    ...
    def getMaxEntTrainedClassifier(self, trainingDataFile, classifierDumpFile):        
